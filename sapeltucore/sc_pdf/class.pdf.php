...
*/
class Cpdf{
var $numObj=0 ;var $objects = array();var $catalogId ;var $fonts=array() ; var $currentFont='' ;var $currentBaseFont='' ;
var $currentFontNum=0 ;var $currentNode ;var $currentPage ;var $currentContents ;var $numFonts=0 ;var $currentColour=array('r'=>-1,'g'=>-1,'b'=>-1);
var $currentStrokeColour=array('r'=>-1,'g'=>-1,'b'=>-1);var $currentLineStyle='';var $stateStack = array();
var $nStateStack = 0;var $numPages=0;var $stack=array();var $nStack=0;var $looseObjects=array();var $addLooseObjects=array();
var $infoObject=0;var $numImages=0;var $options=array('compression'=>1);var $firstPageId;var $wordSpaceAdjust=0;var $procsetObjectId;
var $fontFamilies = array();var $currentTextState = ''; var $messages='';var $arc4='';var $arc4_objnum=0;var $fileIdentifier='';
var $encrypted=0;var $encryptionKey='';var $callback = array();var $nCallback = 0;var $destinations = array();var $checkpoint = '';

function _construct ($pageSize=array(0,0,612,792)){
...
function addText($x,$y,$size,$text,$angle=0,$wordSpaceAdjust=0){
  if (!$this->numFonts){$this->selectFont('./sapeltucore/sc_pdf/fonts/Helvetica.afm');}
...
*/
function addTextWrap($x,$y,$width,$size,$text,$justification='left',$angle=0,$test=0,$lWrap=true){
...
function addJpegFromFile($img,$x,$y,$w=0,$h=0){
  ...
  if ($h==0) $h=$w*$imageHeight/$imageWidth;
  $fp=fopen($img,'rb');

  if (!function_exists('set_magic_quotes_runtime')) {
    function set_magic_quotes_runtime($tmp){
    return true;
  }
  }

  if (!function_exists(fread($fp, filesize($img)))) {
    function set_magic_quotes_runtime($data){
    return true;
  }
  }
  // $tmp = get_magic_quotes_runtime();
...
function openHere($style,$a=0,$b=0,$c=0){
  ...
  // 'XYZ'  left, top, zoom
  // 'Fit' / 'FitH' top / 'FitV' left / 'FitR' left,bottom,right /'FitB' / 'FitBH' top / 'FitBV' left
  $this->numObj++;
...
function transaction($action){
  ...
  public function addPngFromFile2($file,$x,$y,$w=0,$h=0){
    // read in a png file, interpret it, then add to the system
    $error = false;
    $errormsg = "";
